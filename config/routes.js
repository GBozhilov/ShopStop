...
module.exports = (app) => {
    ...
    app.get('/product/delete/:id', auth.isInRole('Admin'), controllers.product.deleteGet);
    app.post('/product/delete/:id', auth.isInRole('Admin'), controllers.product.deletePost);
    ...
    app.get('/product/reset', auth.isInRole('Admin'), controllers.product.resetGet);
    app.post('/product/reset', auth.isInRole('Admin'), controllers.product.resetPost);
    ...
    app.get('/category/:category/products', auth.isAuthenticated, controllers.category.productByCategory);
